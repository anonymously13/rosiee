...
accordionBtns.forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    submenu.style.maxHeight = submenu.scrollHeight ? null : '0px';
  });
});
...
$(document).ready(function() {
  $('.thumbnail-item').click(function(e) {
    ...
    // Optional: Update main image source if you are changing images dynamically
    let newImageSrc = $(this).find('img').attr('src'); 
    $('.detail-thumbnail-image').attr('src', newImageSrc);
  });
});
 i()(".slide-template-slick").slick({
            slidesToShow: 4,
            slidesToScroll: 4,
            arrows: !0,
            dots: !1,
